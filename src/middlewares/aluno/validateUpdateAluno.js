...
class ValidateUpdateAluno extends BaseValidateEntity {
...
export const validateUpdateAluno = (req, res, next) => {
  const validateUpdateAluno = new ValidateUpdateAluno(req, res, next);
  return validateUpdateAluno.handle();
};
